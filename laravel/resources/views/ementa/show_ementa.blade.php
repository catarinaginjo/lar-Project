...
<div class="container" style="margin-bottom: 150px; background-color:white;">
    <table class="table table-striped table-hover" style="border-radius:0.5rem">
        <thead>
            <tr>
                <th scope="col">Dia</th>
    ...
    <h2 style="font-size:20px"><b>Informações adicionais à ementa:</b> {{$ementa->info}}</h2>
    <p style=" margin-top:20px; font-size:20px"><b>Ementa criada por:</b> {{$ementa->nutricionista}}</p>
